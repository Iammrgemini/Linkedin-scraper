...
class CompanyspiderSpider(scrapy.Spider):
    ...
    company_pages = [
        'https://www.linkedin.com/company/citiustech?trk=public_jobs_jserp-result_job-search-card-subtitle',
        'https://www.linkedin.com/company/purple-drive?trk=public_jobs_jserp-result_job-search-card-subtitle',
        'https://www.linkedin.com/company/entech-worldwide?trk=public_jobs_jserp-result_job-search-card-subtitle'
    ]
